...
const ChatBot: React.FC<ChatBotProps> = ({ cvRef }) => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = '/cv.pdf'; // Assurez-vous que ce fichier existe dans votre dossier public
  ...
  const handleEmailContact = () => {
    window.location.href = 'mailto:contact@example.com?subject=Proposition de stage';
  };
